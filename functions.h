...
int searchUserByName(char* name, Facebook& system); // Search for a specific friend from all friends in the system
int searchPageByName(char* name, Facebook& system); // Search for a specific fan page from all fan pages in the system
